...
template <typename KT, typename ICT>
VarigramProbs_t<KT, ICT>::~VarigramProbs_t() {
  delete m_problm;
  delete m_initial_ng;
  delete m_data;
}
...
template <typename KT, typename ICT>
void VarigramProbs_t<KT, ICT>::grow(int iter2_lim) {
...
template <typename KT, typename ICT>
void VarigramProbs_t<KT, ICT>::prune() {
...
template <typename KT, typename ICT>
bool VarigramProbs_t<KT, ICT>::reestimate_with_history(std::vector<KT> &v) {
