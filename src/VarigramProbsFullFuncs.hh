...
#ifndef VARIGRAMPROBSFULLFUNCS_HH
#define VARIGRAMPROBSFULLFUNCS_HH

#include "ProbsLM.hh"
#include <map>

class VarigramProbsFull {
public:
  inline VarigramProbsFull() :
  m_datacost_scale(1),
  m_datacost_scale2(0),
...
class VarigramProbsFull_t : public VarigramProbsFull {
public:
  VarigramProbsFull_t():
  VarigramProbsFull(),
  m_problm(NULL),
...
#include "VarigramProbsFullFuncs_tmpl.hh"
#endif
